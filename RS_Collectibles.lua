...
local Tunables <const> = {
    COLLECTABLES_TRICK_OR_TREAT = 33099,
    COLLECTABLES_SNOWMEN = 34283,
    VC_PEYOTE_ENABLE = 27389,
    FLOW_TIMINGS_TREASURE_HUNT_EMAIL_TIMER = 32019,
    BOUNTYHUNTERHATCHETEMAILTIMER = 24359,
    BOUNTYHUNTERHATCHETEMAILTIMER2 = 24360,
    BOUNTYHUNTERHATCHETEMAILTIMER3 = 24361,
}
